...
# 1 "./src/main/crazepony2_config.h" 1

#define _C2_H_ 


#define C2_VERSION 11
...
const pidProfile_t pgResetTemplate_pidProfile __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .pidController = PID_CONTROLLER_MWREWRITE, .P8[PIDROLL] = 98, .I8[PIDROLL] = 62, .D8[PIDROLL] = 24, .P8[PIDPITCH] = 98, .I8[PIDPITCH] = 64, .D8[PIDPITCH] = 25, .P8[PIDYAW] = 120, .I8[PIDYAW] = 88, .D8[PIDYAW] = 0, .P8[PIDALT] = 40, .I8[PIDALT] = 0, .D8[PIDALT] = 0, .P8[PIDPOS] = 15, .I8[PIDPOS] = 0, .D8[PIDPOS] = 0, .P8[PIDPOSR] = 34, .I8[PIDPOSR] = 14, .D8[PIDPOSR] = 53, .P8[PIDNAVR] = 25, .I8[PIDNAVR] = 33, .D8[PIDNAVR] = 83, .P8[PIDLEVEL] = 13, .I8[PIDLEVEL] = 10, .D8[PIDLEVEL] = 100, .P8[PIDMAG] = 40, .P8[PIDVEL] = 114, .I8[PIDVEL] = 78, .D8[PIDVEL] = 1, .yaw_p_limit = 500, .dterm_lpf = 100, .yaw_lpf = 80, .deltaMethod = PID_DELTA_FROM_MEASUREMENT, }
# 154 "./src/main/flight/pid.c"
 ;
