...
# 56 "./src/main/io/motor_and_servo.c"
const motorAndServoConfig_t pgResetTemplate_motorAndServoConfig __attribute__ ((section(".pg_resetdata"), used, aligned(2))) = { .minthrottle = 1250, .maxthrottle = 1950, .mincommand = 1000, .servoCenterPulse = 1500, .motor_pwm_rate = 16000, .servo_pwm_rate = 50, }
