...
void calculateRxChannelsAndUpdateFailsafe(uint32_t currentTime)
{
 ...
 if(c > 60) {
  c = 0;
  if(APP_DATA_FLAG == 
# 599 "./src/main/rx/rx.c" 3 4
                     1
# 599 "./src/main/rx/rx.c"
                         ) {
   APP_DATA_FLAG = 
# 600 "./src/main/rx/rx.c" 3 4
                  0
# 600 "./src/main/rx/rx.c"
                       ;
   WIFI_DATA_OK = 
# 601 "./src/main/rx/rx.c" 3 4
                 1
# 601 "./src/main/rx/rx.c"
                     ;
  }
  else WIFI_DATA_OK = 
# 603 "./src/main/rx/rx.c" 3 4
                     0
# 603 "./src/main/rx/rx.c"
                          ;
 }
...
# 607 "./src/main/rx/rx.c" 3 4
                         1
# 607 "./src/main/rx/rx.c"
                             ;
...
# 630 "./src/main/rx/rx.c" 3 4
                   0
# 630 "./src/main/rx/rx.c"
                        ;
