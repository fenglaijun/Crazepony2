...
# 36 "./src/main/fc/rate_profile.c" 2
...
{
    for (int i = 0; i < 3; i++) {
# 57 "./src/main/fc/rate_profile.c"
        static const controlRateConfig_t _reset_template_63 = { .rcRate8 = 60, .rcExpo8 = 0, .thrMid8 = 47, .thrExpo8 = 38, .tpa_breakpoint = 1500, }; memcpy((&instance[i]), &_reset_template_63, sizeof(*(&instance[i])));
