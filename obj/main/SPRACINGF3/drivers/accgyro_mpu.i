...
# 1 "./src/main/drivers/accgyro_mpu.c"
# 17 "./src/main/drivers/accgyro_mpu.c"
...
# 18 "./src/main/drivers/accgyro_mpu.c" 2
...
# 23 "./src/main/drivers/accgyro_mpu.c" 2
...
# 27 "./src/main/drivers/accgyro_mpu.c" 2
...
# 29 "./src/main/drivers/accgyro_mpu.c" 2
...
# 31 "./src/main/drivers/accgyro_mpu.c" 2
...
static 
# 48 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 48 "./src/main/drivers/accgyro_mpu.c"
...
static volatile 
# 53 "./src/main/drivers/accgyro_mpu.c" 3 4
               _Bool 
# 53 "./src/main/drivers/accgyro_mpu.c"
                    mpuDataReady;


static 
# 56 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 56 "./src/main/drivers/accgyro_mpu.c"
...
# 62 "./src/main/drivers/accgyro_mpu.c" 3 4
                                             ((void *)0)
# 62 "./src/main/drivers/accgyro_mpu.c"
                                                 ;
...
# 73 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 73 "./src/main/drivers/accgyro_mpu.c"
        ack;
    uint8_t sig;
...
# 86 "./src/main/drivers/accgyro_mpu.c" 3 4
       _Bool 
# 86 "./src/main/drivers/accgyro_mpu.c"
...
static 
# 119 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 119 "./src/main/drivers/accgyro_mpu.c"
           detectSPISensorsAndUpdateDetectionResult(void)
{
# 141 "./src/main/drivers/accgyro_mpu.c"
    return 
# 141 "./src/main/drivers/accgyro_mpu.c" 3 4
          0
# 141 "./src/main/drivers/accgyro_mpu.c"
               ;
}
...
# 147 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
...
void mpuIntExtiHandler(extiCallbackRec_t *cb)
{
    ...
    mpuDataReady = 
# 190 "./src/main/drivers/accgyro_mpu.c" 3 4
                  1
# 190 "./src/main/drivers/accgyro_mpu.c"
                      ;
# 205 "./src/main/drivers/accgyro_mpu.c"
}
...
void configureMPUDataReadyInterruptHandling(void)
{
    ...
    EXTIEnable(mpuIntIO, 
# 221 "./src/main/drivers/accgyro_mpu.c" 3 4
                        1
# 221 "./src/main/drivers/accgyro_mpu.c"
                            );
...
void mpuIntExtiInit(void)
{
    ...
    static 
# 229 "./src/main/drivers/accgyro_mpu.c" 3 4
          _Bool 
# 229 "./src/main/drivers/accgyro_mpu.c"
               mpuExtiInitDone = 
# 229 "./src/main/drivers/accgyro_mpu.c" 3 4
                                 0
# 229 "./src/main/drivers/accgyro_mpu.c"
    ...
    mpuExtiInitDone = 
# 253 "./src/main/drivers/accgyro_mpu.c" 3 4
                     1
# 253 "./src/main/drivers/accgyro_mpu.c"
                         ;
}

static 
# 256 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 256 "./src/main/drivers/accgyro_mpu.c"
           mpuReadRegisterI2C(uint8_t reg, uint8_t length, uint8_t* data)
{
    
# 258 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 258 "./src/main/drivers/accgyro_mpu.c"
        ack = i2cRead(0x68, reg, length, data);
    return ack;
}

static 
# 262 "./src/main/drivers/accgyro_mpu.c" 3 4
      _Bool 
# 262 "./src/main/drivers/accgyro_mpu.c"
           mpuWriteRegisterI2C(uint8_t reg, uint8_t data)
{
    
# 264 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 264 "./src/main/drivers/accgyro_mpu.c"
        ack = i2cWrite(0x68, reg, data);
    return ack;
}


# 268 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 268 "./src/main/drivers/accgyro_mpu.c"
    mpuAccRead(int16_t *accData)
{
    uint8_t data[6];

    
# 272 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 272 "./src/main/drivers/accgyro_mpu.c"
        ack = mpuConfiguration.read(0x3B, 6, data);
    if (!ack) {
        return 
# 274 "./src/main/drivers/accgyro_mpu.c" 3 4
              0
# 274 "./src/main/drivers/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 281 "./src/main/drivers/accgyro_mpu.c" 3 4
          1
# 281 "./src/main/drivers/accgyro_mpu.c"
              ;
}


# 284 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 284 "./src/main/drivers/accgyro_mpu.c"
    mpuGyroRead(int16_t *gyroADC)
{
    uint8_t data[6];

    
# 288 "./src/main/drivers/accgyro_mpu.c" 3 4
   _Bool 
# 288 "./src/main/drivers/accgyro_mpu.c"
        ack = mpuConfiguration.read(mpuConfiguration.gyroReadXRegister, 6, data);
    if (!ack) {
        return 
# 290 "./src/main/drivers/accgyro_mpu.c" 3 4
              0
# 290 "./src/main/drivers/accgyro_mpu.c"
                   ;
    }
    ...
    return 
# 297 "./src/main/drivers/accgyro_mpu.c" 3 4
          1
# 297 "./src/main/drivers/accgyro_mpu.c"
              ;
}


# 300 "./src/main/drivers/accgyro_mpu.c" 3 4
_Bool 
# 300 "./src/main/drivers/accgyro_mpu.c"
    mpuIsDataReady(void)
{
    if (mpuDataReady) {
        mpuDataReady = 
# 303 "./src/main/drivers/accgyro_mpu.c" 3 4
                      0
# 303 "./src/main/drivers/accgyro_mpu.c"
                           ;
        return 
...
# 304 "./src/main/drivers/accgyro_mpu.c"
    ...
    return 
# 307 "./src/main/drivers/accgyro_mpu.c" 3 4
          0
# 307 "./src/main/drivers/accgyro_mpu.c"
               ;
}
