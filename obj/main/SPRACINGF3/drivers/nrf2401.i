...
# 33 "/usr/include/newlib/sys/features.h" 3
...
# 128 "/usr/include/newlib/sys/features.h" 3
...
# 155 "/usr/include/newlib/sys/features.h" 3
#undef _ATFILE_SOURCE
#define _ATFILE_SOURCE 1
# 242 "/usr/include/newlib/sys/features.h" 3
...
# 298 "/usr/include/newlib/sys/features.h" 3
#define __SVID_VISIBLE 1
# 314 "/usr/include/newlib/sys/features.h" 3
...
#undef __EXP
# 44 "/usr/include/newlib/sys/cdefs.h" 2 3
...
# 48 "/usr/include/newlib/stdio.h" 2 3
...
# 10 "/usr/include/newlib/sys/_stdint.h" 3
...
# 65 "/usr/include/newlib/sys/types.h" 2 3
...
{
 static 
# 136 "./src/main/drivers/nrf2401.c" 3 4
       _Bool 
# 136 "./src/main/drivers/nrf2401.c"
            roll_flag,arm_flag;
 ...
 if(!strcmp("$M<",(char *)mspData.checkCode) || WIFI_DATA_OK) {
  ...
  if(mspData.mspCmd & ARM) {
   ...
   if(fabs(flag.pitch) > 700 || fabs(flag.roll) > 700) {
    roll_flag = 
# 166 "./src/main/drivers/nrf2401.c" 3 4
               0
# 166 "./src/main/drivers/nrf2401.c"
                    ;
    mwDisarm();
   }
  }
...
# 173 "./src/main/drivers/nrf2401.c" 3 4
                                 0
# 173 "./src/main/drivers/nrf2401.c"
                                      ;
    else arm_flag = 
# 174 "./src/main/drivers/nrf2401.c" 3 4
                   1
# 174 "./src/main/drivers/nrf2401.c"
                       ;
  }
  ...
  if(mspData.mspCmd & CALIBRATION) {
   ...
   flag.calibration = 
# 180 "./src/main/drivers/nrf2401.c" 3 4
                     1
# 180 "./src/main/drivers/nrf2401.c"
                         ;
  }
...
# 189 "./src/main/drivers/nrf2401.c" 3 4
_Bool 
# 189 "./src/main/drivers/nrf2401.c"
    NRF24L01_init(void)
{
 uint8_t sta;
 ...
 if(NRF24L01_Check()) {
  ...
  return 
# 231 "./src/main/drivers/nrf2401.c" 3 4
        1
# 231 "./src/main/drivers/nrf2401.c"
            ;
 }else return 
# 232 "./src/main/drivers/nrf2401.c" 3 4
             0
# 232 "./src/main/drivers/nrf2401.c"
                  ;
...
# 237 "./src/main/drivers/nrf2401.c" 3 4
_Bool 
# 237 "./src/main/drivers/nrf2401.c"
    NRF24L01_Check(void)
{
 uint8_t buf = 0x77;
    uint8_t buf1;
 ...
 if(buf1 == 0x77)return 
# 246 "./src/main/drivers/nrf2401.c" 3 4
                       1
# 246 "./src/main/drivers/nrf2401.c"
                           ;
  else return 
# 247 "./src/main/drivers/nrf2401.c" 3 4
             0
# 247 "./src/main/drivers/nrf2401.c"
                  ;
}
